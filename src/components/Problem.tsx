      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Tourists from outside the Northeast search for services on Google and Instagram before they arrive. If your <span className="font-semibold text-gray-900">business website doesn't appear</span> there, you're <span className="font-semibold text-red-600">losing real customers</span>. <span className="bg-green-400 px-2 py-1 rounded text-2xl">Website builds trust and make your business into a brand</span> and tourists always prefer website.
          </p>
        </div>
