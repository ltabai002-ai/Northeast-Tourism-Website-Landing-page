      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Tourists from outside the Northeast search for services on Google and Instagram before they arrive. If your business doesn't appear there, you're <span className="font-semibold text-gray-900">losing real customers</span>.
          </p>
        </div>
