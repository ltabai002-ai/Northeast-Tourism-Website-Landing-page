        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-teal-500 to-sky-500 rounded-lg flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#portfolio" className="hover:text-teal-400 transition-colors duration-300">
                  Portfolio
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919876543210" className="hover:text-teal-400 transition-colors duration-300">
                  +91 98765 43210
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-teal-400 flex-shrink-0" />
                <a href="mailto:hello@newebdesign.in" className="hover:text-teal-400 transition-colors duration-300">
                  hello@newebdesign.in
                </a>
              </li>
            </ul>
          </div>
